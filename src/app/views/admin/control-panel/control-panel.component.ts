...
export class ControlPanelComponent implements OnInit {
  ...
  constructor(
    ...
    public commonService: CommonService, private api: ApiService
  ) { }
  ...
  clientHub() {
    ...
    this.adminApi.LIVE_CURRENCIES().subscribe(result => {
      ...
      if(result.status) result.list.forEach(element => { this.commonService.currency_types.push({ base: element.base }); });
